...
export default function terminal() {
  ...
  return (
    <div
      className="flex flex-1 min-h-0 w-full flex-col overflow-hidden text-gray-200 antialiased transition-colors duration-300"
      ...
      <div className="relative flex min-h-0 flex-1 flex-col gap-4 p-4 sm:p-6">
                            ...
                            <span className="flex h-2.5 w-16 gap-0.5 overflow-hidden rounded-sm">
                              {[
                                ...
                                <span
                                  ...
                                  style={{
                                    background:
                                      t.colors[c as keyof typeof t.colors],
                                  }}
                                />
                              ))}
                            </span>
        ...
        >
          <div
            ...
            style={{ borderColor: hexToCssRgb(ui.text, 0.05) }}
          >
            ...
            <div
              ...
              style={{ color: ui.muted }}
            >
              {theme.name} · {termRef.current?.cols ?? "80"}×
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <span style={{ color: ui.muted }}>
                UTF-8 <span style={{ color: ui.muted, opacity: 0.5 }}>|</span>{" "}
                unix
              </span>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span
                className="rounded px-2 py-0.5"
                style={{
                  background: hexToCssRgb(ui.accent2, 0.1),
                  color: ui.accent2,
                }}
              >
                TS
